...
updated: 2026-02-11T14:51:44-0600
version: 1.1.1
---
...
proyecto tenga una estructura clara en el árbol de directorios
que podrá ser tomado desde mi github una vez se
haya formalizado todo (está público, no sé si sea bueno).

Para lograr que mi trabajo sea correcto, si bien no puedo hacer
un sistema de ficheros de múltiple enlace, al menos puedo dar
a entender la estructura plana del árbol.
...
- test_fitness ............ # Realiza pruebas de verificación de la función de fitness sobre la función potencial a través de su definición simbólica
...
divididas en 100 iteraciones del optimizador por cada elemento
de la base de datos original, con 75 elementos cada base de
datos. Una en búsqueda de Veff y otra con Veff_lift.
